...
interface OpenAIStructuredRequest extends AgentRunInput {
...
export interface OpenAIModelProviderSdk {
  generateStructured(input: OpenAIStructuredRequest): Promise<OpenAIStructuredResponse>;
...
function createOpenAISdk(configuration: OpenAIModelProviderConfiguration): OpenAIModelProviderSdk {
  ...
  return Object.freeze({
    async generateStructured(input: OpenAIStructuredRequest): Promise<OpenAIStructuredResponse> {
